...
//TODO: n'est pas prête, juste mise en place
//Va lire la génération que l'on a faite du graph un peut à la manière qu'un fichier est lu, servira pour construir les Graph pour le questio n4
public class Lecteur_Generation {
	...
	public Lecteur_Generation(int nb_a) {
		data_d = new int[nb_a];
		data_a = new int[nb_a];
	}
